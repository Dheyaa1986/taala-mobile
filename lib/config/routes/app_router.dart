...
import '../../features/auth/register/presentation/screens/registration_otp_screen.dart';
      ...
      routes: <RouteBase>[
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) => screenWithFadeTransition(
            context: context,
            state: state,
            child: CreateServiceOrderScreen(
              args: state.extra as CreateServiceOrderArgs?,
            ),
          ),
        ),
        GoRoute(
